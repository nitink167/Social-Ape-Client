    ...
    render() {
        ...
        return (
            <Grid container className={ classes.form}>
                <Grid item sm/>
                <Grid item sm>
                    <img src={ AppIcon } alt="SocialApe" className= { classes.image } />
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <TextField id="handle" name="handle" type="text" label="User Name / Handle" className={classes.textField} helperText={errors.handle} error={errors.handle ? true : false} value={this.state.handle} onChange={this.handleChange} fullWidth />
                        { errors.general && (
